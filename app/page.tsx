      ...
      <div className="w-full max-w-lg mx-auto lg:mx-0 lg:max-w-full grid lg:grid-cols-2 gap-6  items-center py-6">
        ...
        >
          ...
          <p className="text-justify">
            ...
            intuitive designs while continuously expanding my knowledge of
            modern frontend technologies like React, Next.js, and TypeScript.
            I&apos;m currently seeking entry-level opportunities where I can
            apply my skills, grow professionally, and contribute meaningfully to
            projects.I am committed to delivering high-quality solutions that
            enhance user experience and add real value. I&apos;m excited to
            collaborate with teams, learn from new challenges, and bring
            innovative ideas to life through my work.
          </p>
        </motion.div>
      </div>
    </Container>
